...
## Model
www.msaez.io/#/storming/hotelcmshsjnewnewbox
...
- cleaningstatus
```
 http :8088/housekeepings housekeepingId="housekeepingId" accomodationId="accomodationId" housekeeperId="housekeeperId" cleaned="cleaned" roomId="roomId" accomodationId="accomodationId" housekeeperId="housekeeperId" cleaned="cleaned" roomId="roomId" 
```
